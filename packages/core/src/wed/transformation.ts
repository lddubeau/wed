...
/**
 * An interface modeling transformations for which we do not have precise
 * information regarding what data they accept.
 */
export interface UnspecifiedTransformation
// tslint:disable-next-line:no-any
extends Transformation<any>, UnspecifiedAction {
}
...
export class TransformationEvent {
  ...
  constructor(readonly name: "StartTransformation" | "EndTransformation",
              readonly transformation: UnspecifiedTransformation) {}
