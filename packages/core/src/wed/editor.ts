...
export const version = "5.0.0-alpha.26";
  ...
  private globalKeydownHandler(wedEvent: JQuery.Event,
    ...
    if (keyConstants.SPACE.matchesEvent(e)) {
      ...
      if (attrVal !== null) { // In attribute.
        ...
        const next = caretMovement.nextCaretPositionNoText(selFocus.toArray(),
                                                           this.guiRoot)![0];
        if (!isElement(next) ||
      ...
      if (attrVal !== null) { // In attribute.
        ...
        const prev = caretMovement.prevCaretPositionNoText(selFocus.toArray(),
                                                           this.guiRoot)![0];
        if (!isElement(prev) ||
