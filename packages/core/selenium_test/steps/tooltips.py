...
@when(r"the user moves the mouse over a start label")
...
@when(r"the user moves the mouse off the start label")
def step_impl(context):
    driver = context.driver
    util = context.util
...
@given(r"there are no tooltips")
@then(r"there are no tooltips")
def step_impl(context):
